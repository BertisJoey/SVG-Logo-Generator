//These import the node modules in use
const inquirer = require('inquirer');
const fs = require('fs');

//These import the other js files where the shape attribute is generated
...
//This object array will contain the questions that are prompted
function promptUser() {
    inquirer
        .prompt([
            {
